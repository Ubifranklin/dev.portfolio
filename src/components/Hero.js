...
const Hero = () => {
  ...
  // Words to rotate through in the typing animation
  const rotatingWords = [
        ...
        <div>
          ...
          <div style={{
            ...
            {Object.entries(portfolioData.social).map(([platform, url]) => (
              ...
              >
                {platform === 'github' && <img src="/images/github.png" alt="GitHub" style={{ width: "32px", height: "32px", margin: "0 10px", cursor: "pointer" }}/>}
                {platform === 'linkedin' && <img src="/images/linkedin.png" alt="LinkedIn" style={{ width: "32px", height: "32px", margin: "0 10px", cursor: "pointer" }} />}
                {platform === 'twitter' && <img src="/images/twitter.png" alt="Twitter" style={{ width: "32px", height: "32px", margin: "0 10px", cursor: "pointer" }}/>}
                {platform === 'portfolio' && <img src="/images/facebook.png" alt="Facebook" style={{ width: "32px", height: "32px", margin: "0 10px", cursor: "pointer" }}/>}
                {platform === 'instagram' && <img src="/images/instagram.png" alt="Instagram" style={{ width: "32px", height: "32px", margin: "0 10px", cursor: "pointer" }}/>}
              </a>
            ))}
          </div>
        </div>
            ...
            <div style={{
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(personal.name)}&size=320&background=${theme.primary.slice(1)}&color=ffffff&bold=true`;
                }}
              />
            </div>
